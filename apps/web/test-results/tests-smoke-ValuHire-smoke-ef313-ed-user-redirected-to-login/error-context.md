...
- Name: tests/smoke.spec.js >> ValuHire smoke tests >> unauthenticated user redirected to login
- Location: tests/smoke.spec.js:26:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/recruiter
Call log:
  - navigating to "http://localhost:3000/recruiter", waiting until "load"
